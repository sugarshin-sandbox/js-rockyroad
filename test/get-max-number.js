...
describe('get-max-number', () => {
  ...
  it('case 5', () => {
    const arr = func([64364367, 6436436642, 6436436642, 8, 67]);
  ...
  it('case 6', () => {
    const arr = func([64364366, 6436436642, 6436436642, 8, 67]);
  ...
  it('case 7', () => {
    const arr = func([64364366, 6436436672, 6436436642, 8, 67]);
